...
import {SiSkypack} from "react-icons/si"
    ...
    <Navbar expanded={expand}
      ...
      <Navbar.Collapse id="responsive-navbar-nav" className='responsive-navbar'>
        ...
        <Nav className="ms-auto" defaultActiveKey="#home">
          ...
          <Button
            onClick={() => {
              window.open("https://drive.google.com/file/d/1wKD7PP6i9_aemLAJBxAETP2GhkykkFaB/view?usp=share_link");
            }}
